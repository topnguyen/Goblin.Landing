...
namespace Goblin.Landing.Repository
{
    ...
    public sealed partial class Landing_DbContext : Elect.Data.EF.Services.DbContext.DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(connectionString, sqlServerOptionsAction =>
            {
                ...
                sqlServerOptionsAction.MigrationsAssembly(typeof(Landing_DbContext).GetTypeInfo().Assembly.GetName().Name);
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.AddConfigFromAssembly<Landing_DbContext>(typeof(Landing_DbContext).GetTypeInfo().Assembly);
