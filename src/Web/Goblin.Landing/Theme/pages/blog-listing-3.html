...
<html lang="en">
  ...
  <body>
    ...
    <!-- <div class="alert alert-dismissible d-none d-md-block bg-primary text-white py-4 py-md-3 px-0 mb-0 rounded-0 border-0">
    <div class="container">
        <div class="row no-gutters align-items-md-center justify-content-center">
            <div class="col-lg-11 col-md d-flex flex-column flex-md-row align-items-md-center justify-content-lg-center">
                ...
                <a class="btn btn-sm btn-light ml-md-3" target="_blank" href=#>Redeem Offer</a>
            </div>
      ...
      <div class="container">
        <div class="row section-title justify-content-center text-center">
          <div class="col-md-9 col-lg-8 col-xl-7">
            <h1 class="display-3">Newsroom</h1>
        ...
        <div class="row justify-content-center">
          <div class="col-xl-5 col-lg-9 col-md-10 mb-3 mb-sm-5" data-aos="fade-up" data-offset="200">
            <div class="card card-body hover-box-shadow bg-white">
              <img src="assets/img/avatars/male-1.jpg" alt="Joshua Lapinsky profile image" class="avatar mt-md-n5 mb-3">
              <div>
                <div class="text-muted mb-3">October 10th</div>
                <a href="#">
                  <h3 class="h2">Unveiling our new vision for Jumpstart</h3>
                </a>
                <p>
          ...
          <div class="col-xl-5 col-lg-9 col-md-10 mb-3 mb-sm-5" data-aos="fade-up" data-offset="200">
            <div class="card card-body hover-box-shadow bg-white">
              <img src="assets/img/avatars/female-1.jpg" alt="Glenda Spence profile image" class="avatar mt-md-n5 mb-3">
              <div>
                <div class="text-muted mb-3">October 2nd</div>
                <a href="#">
                  <h3 class="h2">Making the most of team-building sessions</h3>
                </a>
                <p>
          ...
          <div class="col-xl-5 col-lg-9 col-md-10 mb-3 mb-sm-5" data-aos="fade-up" data-offset="200">
            <div class="card card-body hover-box-shadow bg-white">
              <img src="assets/img/avatars/male-2.jpg" alt="Michael Trossino profile image" class="avatar mt-md-n5 mb-3">
              <div>
                <div class="text-muted mb-3">September 13th</div>
                <a href="#">
                  <h3 class="h2">Keep your users engaged in their sleep</h3>
                </a>
                <p>
          ...
          <div class="col-xl-5 col-lg-9 col-md-10 mb-3 mb-sm-5" data-aos="fade-up" data-offset="200">
            <div class="card card-body hover-box-shadow bg-white">
              <img src="assets/img/avatars/male-3.jpg" alt="Patrik Janssen profile image" class="avatar mt-md-n5 mb-3">
              <div>
                <div class="text-muted mb-3">August 8th</div>
                <a href="#">
                  <h3 class="h2">It's not just about the clicks. Here's why</h3>
                </a>
                <p>
          ...
          <div class="col-xl-5 col-lg-9 col-md-10 mb-3 mb-sm-5" data-aos="fade-up" data-offset="200">
            <div class="card card-body hover-box-shadow bg-white">
              <img src="assets/img/avatars/female-2.jpg" alt="Mirembe Nkrumah profile image" class="avatar mt-md-n5 mb-3">
              <div>
                <div class="text-muted mb-3">July 21st</div>
                <a href="#">
                  <h3 class="h2">Why social ROI is impossible to measure</h3>
                </a>
                <p>
          ...
          <div class="col-xl-5 col-lg-9 col-md-10 mb-3 mb-sm-5" data-aos="fade-up" data-offset="200">
            <div class="card card-body hover-box-shadow bg-white">
              <img src="assets/img/avatars/female-3.jpg" alt="Karina Messopine profile image" class="avatar mt-md-n5 mb-3">
              <div>
                <div class="text-muted mb-3">June 30th</div>
                <a href="#">
                  <h3 class="h2">Breathing new life into a tired UI</h3>
                </a>
                <p>
